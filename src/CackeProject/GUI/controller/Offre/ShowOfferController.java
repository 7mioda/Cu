...
public class ShowOfferController implements Initializable, FlashSaleInterface {
    ...
    public void initVariable(int id){
        ...
        ObservableList<Product> myOb = FXCollections.observableArrayList(this.offre.getProduct());
